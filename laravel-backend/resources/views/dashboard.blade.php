...
<body class="bg-gray-100 p-6">
    <div class="max-w-6xl mx-auto">
        <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
            ...
            <div class="flex flex-wrap gap-3 items-center">
                ...
                <select id="filterUnit" aria-label="Filter by Unit"
                    class="p-2 border rounded-lg bg-white shadow-sm outline-none focus:ring-2 focus:ring-blue-400 text-sm font-semibold">
                    ...
                    <option value="Unit Pelantar Pembelajaran">Unit Pelantar Pembelajaran
                    </option>
                </select>
        ...
        <div class="mb-8 bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
            <h2 class="text-lg font-bold text-slate-800 mb-4">Reports by User</h2>
